...
function NewsTicker() {
  ...
  return (
    <div className="flex items-stretch overflow-hidden border-t border-gold/30 bg-navy-deep text-primary-foreground">
      ...
      <div className="flex shrink-0 items-center px-2 z-10">
        <NotificationBell className="flex items-center gap-1 whitespace-nowrap rounded-full border border-gold/60 px-2 py-0.5 text-[10px] font-bold text-gold transition-colors hover:bg-gold hover:text-accent-foreground disabled:opacity-60" />
      </div>
    </div>
  );
}
