        ...
        <>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 border-t border-border pt-6">
            <button
              ...
              className="flex items-center gap-2 rounded-full border border-gold px-4 py-2 text-sm font-bold text-gold-deep transition-colors hover:bg-gold hover:text-accent-foreground"
            >
              <svg
                width="16"
                height="16"
